        ...
        <div className="absolute right-0 top-10 z-50 w-64 rounded-2xl border border-slate-100 bg-white shadow-xl shadow-slate-200/60 animate-fade-in">
          ...
          <div className="px-4 py-2.5 border-b border-slate-50">
            <div className="flex items-center justify-between">
              ...
              <span className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-semibold ${tier.bg} ${tier.color}`}>
                {tier.label}
              </span>
            </div>
          </div>
          ...
          <div className="p-1.5">
            ...
            {user.subscriptionTier === 'FREE' && (
              <div className="mx-2 my-2 rounded-xl bg-linear-to-r from-blue-50 to-indigo-50 border border-blue-100 p-3">
                <p className="text-xs font-semibold text-blue-800 mb-1">Upgrade to Pro</p>
                <p className="text-xs text-blue-600 mb-2">100 audits/day + priority processing</p>
